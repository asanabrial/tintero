export interface TagsListHrefParams {
...
/**
 * Pure helper — builds the href for admin Tags list links.
 * Param order in the serialized URL: q -> page.
 * No React/Next.js imports; safe to use in tests without a DOM.
 */
export function buildTagsListHref({ q, page }: TagsListHrefParams): string {
