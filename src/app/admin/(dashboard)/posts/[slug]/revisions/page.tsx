// Revisions list page for a post — server component.
...
async function RevisionsContent({ params }: RevisionsContentProps) {
  ...
  try {
    revisions = await getRevisionRepository().listForSlug("post", slug);
  } catch {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-6">
        {t(loc, "admin.revisions.postLabel")}{" "}
          ...
          {revisions.map((rev) => (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <a
                  href={`/admin/posts/${slug}/revisions/${rev.id}`}
